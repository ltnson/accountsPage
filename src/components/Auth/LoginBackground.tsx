...
const LoginBackground = () => {
  return (
    <div className="h-screen grid grid-cols-8 pl-8  w-full relative">
      <div className="flex gap-x-5 h-full col-span-3 2xl:col-span-4 w-full">
        <div className="w-4/12 bg-cyan" />
        <div className="w-2/12 bg-cyan" />
        <div className="w-1/12 bg-cyan" />
      </div>
      <div className="flex items-center col-span-5 w-full 2xl:col-span-4">
