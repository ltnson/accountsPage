  ...
  return (
    <div className="col-span-2">
      <TextField
        ...
        InputProps={{
          startAdornment: (
            <div className="flex gap-x-1 items-center flex-nowrap min-w-[1280px] overflow-auto">
              {skill.map((sk, index) => (
                <div className="rounded-xl border border-t-light text-center flex items-center">
                  <div
                    onClick={() =>
